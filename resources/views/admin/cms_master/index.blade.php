...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="col">
        <h1 class="h3 mb-1 text-gray-800">CmsMaster Management</h1>
    </div>
    <a class="b1 btn btn-danger mr-1 mb-2" href="{{ Route('cms_master.deactive') }}">Deactivated CmsMasters</a>
    <a class="btn btn-primary mb-2" href="{{ Route('cms_master.create') }}">Add</a>
</div>
