                    ...
                    <div class="col">
                        <div class="form-floating">
                            <input type="text" name="category_name_guj" id="category_name"
                                placeholder="Category Name Gujarati" class="form-control" value="{{$category->categoryNameGuj}}">
                    ...
                    <div class="col">
                        <div class="form-floating">
                            <input type="text" name="category_name_hin" id="category_name"
                                placeholder="Category Name Hindi" class="form-control" value="{{$category->categoryNameHin}}">
                            ...
                            <div class="col">
                                <div class="form-floating">
                                    <input type="text" name="category_des" id="category_name"
                                        placeholder="Category Name" class="form-control" value="{{$category->categoryDescription}}">
                                    <label for="">English</label>
                                    <span id="nameError" class="text-danger"></span>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-floating">
                                    <input type="text" name="category_des_guj" id="category_name"
                                        placeholder="Category Name" class="form-control" value="{{$category->categoryDescriptionGuj}}">
                                    <label for="">Gujarati</label>
                                    <span id="nameError" class="text-danger"></span>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-floating">
                                    <input type="text" name="category_des_hin" id="category_name"
                                        placeholder="Category Name" class="form-control" value="{{$category->categoryDescriptionHin}}">
                                    <label for="">Hindi</label>
                                    <span id="nameError" class="text-danger"></span>
                                </div>
                            </div>
